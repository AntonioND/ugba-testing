...
// Example of how to load a 16-color sprite using low-level definitions

#include <ugba/ugba.h>

#include "graphics/ball_palette_bin.h" // Autogenerated from ball.png
#include "graphics/ball_tiles_bin.h"
...
int main(int argc, char *argv[])
{
    ...
    // palette.
    uint16_t *spr_pal = MEM_PALETTE_OBJ + (BALL_PALETTE * 16);
    SWI_CpuSet_Copy16(ball_palette_bin, spr_pal, ball_palette_bin_size);
...
#define TILE_SIZE ((4 * 8 * 8) / 8)
    ...
    SWI_CpuFastSet_Copy32(ball_tiles_bin, spr_tiles, ball_tiles_bin_size);
