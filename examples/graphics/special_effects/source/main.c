...
#include "graphics/ball_green.h" // Autogenerated from ball_green.png
#include "graphics/ball_red.h"   // Autogenerated from ball_red.png
...
int main(int argc, char *argv[])
{
    ...
    int evb = 5;
    int evy = 10;
    uint16_t effect = BLDCNT_ALPHA_BLENDING;

    while (1)
    {
        DISP_BlendSetup(BLDCNT_1ST_OBJ, BLDCNT_2ND_BG2, effect);
        DISP_BlendAlphaSet(eva, evb);
        DISP_BlendYSet(evy);
        ...
        {
            // Get next effect
            effect = (effect + BLDCNT_ALPHA_BLENDING) & (3 << 6);
        }
